...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lemonImage!!.setOnClickListener {
            clickLemonImage()
            setViewElements()// TODO: call the method that handles the state when the image is clicked
        }
    ...
    private fun setViewElements() {
        ...
        val lemonImageNew: ImageView=findViewById(R.id.image_lemon_state)


        if(lemonadeState==SELECT)
        {
            textAction.setText(R.string.lemon_select)
            lemonImageNew.setImageResource(R.drawable.lemon_tree)

        }
        if(lemonadeState==SQUEEZE)
        {
            textAction.setText(R.string.lemon_squeeze)
            lemonImageNew.setImageResource(R.drawable.lemon_squeeze)
        }
        if(lemonadeState==DRINK)
        {
            textAction.setText(R.string.lemon_drink)
            lemonImageNew.setImageResource(R.drawable.lemon_drink)
        }
        if(lemonadeState==RESTART)
        {
            textAction.setText(R.string.lemon_empty_glass)
            lemonImageNew.setImageResource(R.drawable.lemon_restart)
        }
